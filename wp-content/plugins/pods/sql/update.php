<?php
if (version_compare($installed, '1.2.6', '<')) {
...
if (version_compare($installed, '1.2.7', '<')) {
...
if (version_compare($installed, '1.3.2', '<')) {
...
if (version_compare($installed, '1.4.5', '<')) {
...
if (version_compare($installed, '1.4.8', '<')) {
    add_option('pods_roles');
    update_option('pods_version', '148');
}

if (version_compare($installed, '1.4.9', '<')) {
